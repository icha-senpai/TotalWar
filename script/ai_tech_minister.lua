...
function Process_Tech(pYear, pMaxYear, ResearchSlotsAllowed, ResearchSlotsNeeded)
	...
	laPrimeTechAreas[_RESEARCH_LAND_] = {
								Folder = {
									...
									"artillery_folder",
									"armour_folder",
									"advanced_land_tech_folder",
									"special_forces_folder",
									"infantry_organization_folder",
									"armor_organization_folder",
									"advanced_organization_folder"
								},
								ResearchWeight = 0, 
								CurrentSlots = 0, 
								ResearchSlots = 0, 
	...
	laPrimeTechAreas[_RESEARCH_LAND_DOC_] = {
								Folder = {
									"training_doctrine_folder",
									"strategic_doctrine_folder",
									"special_forces_doctrine_folder",
									"advanced_land_doctrine_folder",
									"tactical_doctrine_folder"
								},
								ResearchWeight = 0, 
								CurrentSlots = 0, 
								ResearchSlots = 0, 
	...
	laPrimeTechAreas[_RESEARCH_AIR_] = {
								Folder = {
									"light_aircraft_folder",
									"naval_aircraft_folder",
									"medium_aircraft_folder",
									"heavy_aircraft_folder",
									"aircraft_armament_folder",
									"aircraft_system_folder",
									"jet_aircraft_folder",									
									"advanced_aircraft_folder"
								},
								ResearchWeight = 0, 
								CurrentSlots = 0, 
								ResearchSlots = 0, 
	...
	laPrimeTechAreas[_RESEARCH_AIR_DOC_] = {
								Folder = {
									"air_doctrine_folder",
									"advanced_naval_and_air_doctrine_folder"
								},
								ResearchWeight = 0, 
								CurrentSlots = 0, 
								ResearchSlots = 0, 
	...
	laPrimeTechAreas[_RESEARCH_NAVAL_] = {
								Folder = {
									...
									"capitalship_folder",
									"carrier_folder",									
									"advanced_submarine_folder",
									"advanced_ship_folder"
								},
								ResearchWeight = 0, 
								CurrentSlots = 0, 
								ResearchSlots = 0, 
	...
	for k, v in pairs(laPrimeTechAreas) do
		...
		if not TechnologyData.IsAtWar or (TechnologyData.ministerTag == chiT and TY < 1938) or (TechnologyData.ministerTag == japT and TY < 1938) or (TechnologyData.ministerTag == usaT and TY < 1941)then
			...
			table.insert(v.ListPrefer, "university_scientists")
		else
			v.ListPrefer = {}
