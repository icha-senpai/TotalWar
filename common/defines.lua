...
military = {
	...
	ENVELOPMENT_PENALTY = 0.15,	-- envelopment penalty, for each direction.
	...
	AIR_COMBAT_ORG_DAMAGE_MODIFIER = 7.0,
	AIR_COMBAT_STR_DAMAGE_MODIFIER = 25.0,
	...
	AIR_COMBAT_CAG_ORG_DAMAGE_MOD = 0.2, -- ORG damage to CAGs is multiplied by this
	AIR_COMBAT_CAG_STR_DAMAGE_MOD = 3.0, -- STR damage to CAGs is multiplied by this
	...
	NAVAL_COMBAT_ORG_DAMAGE_MODIFIER = 0.1, -- Average damage is the same, but it will be more consistent with less randomness.
	...
	INFRA_THROUGHPUT_IMPACT = 5,
	SURPRISE_BONUS = 0.33,
	STATIC_AA_SCALE = 7.0,
	AIR_SUPPLY_FACTOR = 0.25,
	UNIT_UPGRADE_COST = 0.4, -- was 0.5
	...
	CAG_SHIP_ATTACK_STR_BONUS = 1.1, -- attack bonus if CAG attacks ships who are busy in combat
	CAG_SHIP_ATTACK_ORG_BONUS = 1.5,
